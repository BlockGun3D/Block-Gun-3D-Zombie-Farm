...
public class FirstPersonControl : MonoBehaviour
{
	...
	public virtual void Update()
	{
		...
		motion.y = 0f;
		motion.Normalize();
		Vector2 vector = (Application.isMobilePlatform ? new Vector2(Mathf.Abs(moveTouchPad.position.x), Mathf.Abs(moveTouchPad.position.y)) : new Vector2(Input.GetAxis("Horizontal"), Input.GetAxis("Vertical")));
